      ...
      <div class="container">
        <div class="row">
          <div class="col s10 m6 l6 breadcrumbs-left">
            <h5 class="breadcrumbs-title mt-0 mb-0 display-inline hide-on-small-and-down">Edit Project</h5>
      ...
      <div class="container">
        ...
        <div id="button-trigger" class="card card card-default scrollspy">
            <div class="card-content">
                <form class="col s12" method="POST" action="{{route('projects.update', $project->id)}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                <div class="row">
                    <div class="input-field col s12">
                    <input placeholder="xyz company branding" id="name2" name="project_title" type="text" value="{{ $project->project_title }}">
                ...
                <div class="row">
                    <div class="input-field col s12">
                    <input placeholder="Sohag Ahmed" id="client" name="client_name" type="text" value="{{ $project->client_name }}">
                ...
                <div class="row">
                    <div class="input-field col s12 mt-4">
                        <select name="category_id" id="category_id">
                            ...
                            <option @if ($project->category_id == $cat->id)
                                selected
                ...
                <div class="row">
                    <div class="input-field col s12">
                      <textarea placeholder="Write project details" id="project_details" name="project_details" class="materialize-textarea">{{ $project->project_details }}</textarea>
